...
<head runat="server">
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="/Tasarım/vendors/ti-icons/css/themify-icons.css">
    <link rel="stylesheet" href="/Tasarım/vendors/base/vendor.bundle.base.css">
    <!-- endinject -->
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="/Tasarım/images/favicon.png" />
</head>
<body>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="/Tasarım/images/logo.svg" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="/Tasarım/images/logo-mini.svg" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="/Tasarım/images/faces/face4.jpg" alt="image" class="profile-pic">
                </div>
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="/Tasarım/images/faces/face2.jpg" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
              ...
              <a class="dropdown-item">
                <div class="item-thumbnail">
                    <img src="/Tasarım/images/faces/face3.jpg" alt="image" class="profile-pic">
                </div>
                <div class="item-content flex-grow">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="/Tasarım/images/faces/face28.jpg" alt="profile"/>
            </a>
  ...
  <!-- inject:js -->
  <script src="/Tasarım/js/off-canvas.js"></script>
  <script src="/Tasarım/js/hoverable-collapse.js"></script>
  <script src="/Tasarım/js/template.js"></script>
  <script src="/Tasarım/js/todolist.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="/Tasarım/js/dashboard.js"></script>
